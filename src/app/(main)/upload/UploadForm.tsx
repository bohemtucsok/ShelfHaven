...
export default function UploadForm() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      <Link
        href="/library"
        className="mb-6 inline-flex items-center gap-1.5 text-sm font-medium text-amber-700 transition-colors hover:text-amber-600 dark:text-[var(--accent-gold)] dark:hover:text-[var(--accent-copper)]"
      >
